...
def compute_embedding_loop(data_loader,params):
...
#     model_path = "/home/qinyc/speechbrain-develop/speechbrain/lobes/models/ECAPA_TDNN.py"
#     shutil.copy(os.path.join(params["save_folder"],"ECAPA_TDNN.py"),model_path)
